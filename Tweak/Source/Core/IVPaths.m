...
// plists, and each container skeleton dir). Badoo provisions its container
...
// Badoo in the background during a lock (push wake / background refresh),
...
// session looks logged out. Downgrading OUR control files (never Badoo's own
...
+ (NSString *)controlDir {
    NSString *dir = [[[self realHome] stringByAppendingPathComponent:@"Documents"]
                        stringByAppendingPathComponent:@"BadooVault"];
