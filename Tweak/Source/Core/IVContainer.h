...
/// A single isolated container ("a phone" from Badoo's point of view).
...
/// Auto-swipe (per-container bot). Drives Badoo's OWN on-screen UI while this
...
/// (no Badoo private headers) — see IVAutoSwipe.
///
