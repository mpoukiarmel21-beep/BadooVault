...
- (void)load {
    ...
    @try {
        ...
        // silently degrading to default runs Badoo against the REAL keychain
...
- (BOOL)persistLocked {
    ...
    // matching the control dir's protection (see IVPaths). Badoo's sandbox defaults
...
- (BOOL)resetAll {
    ...
    @try {
        ...
        //   (3) The live NSHTTPCookieStorage jar — Badoo keeps the running
