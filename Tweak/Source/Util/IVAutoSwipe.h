...
/// Per-container auto-swipe bot. Drives Badoo's OWN on-screen UI (the app's live
...
///
/// HONEST LIMITS (no Badoo private headers, substrate-free): detection is a
/// best-effort heuristic over the accessibility tree + visible labels. Badoo can
...
/// dismissed (so Badoo's UI — not ours — is frontmost). Everything is logged
