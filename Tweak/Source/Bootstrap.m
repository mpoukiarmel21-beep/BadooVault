...
// New files Badoo writes at runtime (cookies, tokens, WebKit/HTTPStorages,
...
static void IVBootstrap(void) {
    @autoreleasepool {
        ...
        //    container shared) is a cross-container identity leak: Badoo' FBSDK
        ...
        //     account). If a global video is set, feed it into Badoo's OWN native
        ...
        //     Badoo's in-app AVFoundation camera only; NOT Veriff's WebView
