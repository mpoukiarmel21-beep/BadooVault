...
# ============================================================
# BadooVault - IPA Builder (LOCAL / manual fallback)
# Compiles tweak + injects into a Badoo IPA.
...
echo -e "${BLUE}=== BadooVault IPA Builder ===${NC}"

# --- Config ---
INPUT_IPA="${1:-Input.ipa}"
OUTPUT_IPA="BadooVault.ipa"
DYLIB="obj/BadooVault.dylib"
...
# The Badoo repacker IPA ships four mod dylibs in Frameworks/ that are NOT
...
cp "/$OLDPWD/$DYLIB" "$APP_PATH/Frameworks/BadooVault.dylib"
optool install -c load -p @executable_path/Frameworks/BadooVault.dylib -t "$APP_PATH/$APP_NAME"
